...
include_paths = [
    ...
    "src/game",
    "include/game",
    "library/adsl/gfx/include",
#    "library/adsl/gfx/src",
    "library/adsl/anim/include",
#    "library/adsl/anim/src",
#    "library/NintendoWare/font/include",
#    "library/NintendoWare/lyt/include",
#    "library/NintendoWare/project/include",
...
def get_type_inc(sym=None, main_data=None, traversed=None):
    ...
    if not os.path.exists(file_path):
        print("nn/types.h missing, halt with detail.")
        return ""
