...
//  START FUNC
    ...
    void FUN_00586acc(uint,int); // might be a __thiscall..?
    void FUN_00586b30(int,int); // might be a __thiscall..?
    void FUN_00586c24(uint,int); // might be a__thiscall..?
    void FUN_00586d14(uint,int); // might be a__thiscall..?
    void FUN_00586c50(int); // might be a__thiscall..?
    void FUN_00586d40(byte,int); // might be a__thiscall..?
    void FUN_00586d50(ushort); // might be a__thiscall..?
    void FUN_00586d74(void); // might be a__thiscall..?
    int FUN_00586dbc(int,int); // might be a__thiscall..?
    ...
    ushort FUN_005f1120(int,uint); // might be a__thiscall..? could be sum else
    uint FUN_005f1148(uint); // __thiscall
    ...
    void calcPc(DataPc*,int); // goes 2 UpdatePcStatus
    uint calcplayTime();
    ...
    int addCoin(int); // only int in static
