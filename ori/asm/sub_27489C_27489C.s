...
ORR             R0, R0, R10
BICS            R1, R0, #0xF
BNE             def_2748D8; jumptable 002748D8 default case, cases 0,2,4,5,7
CMP             R0, #0xB; switch 11 cases
LDRCC           PC, [PC,R0,LSL#2]; switch jump
B               def_2748D8; jumptable 002748D8 default case, cases 0,2,4,5,7
DCD def_2748D8; jump table for switch statement
VLDR            S0, [R5,#0x84]; jumptable 002748D8 case 1
VLDR            S1, [R6,#0x84]
VCMP.F32        S0, S1
...
LDRB            R0, [R0]
CMP             R0, #0
BEQ             def_2748D8; jumptable 002748D8 default case, cases 0,2,4,5,7
ADD             R0, R4, #0x24 ; '$'
STM             R0, {R5,R6}
LDR             R0, [R5]
LDR             R1, [R0,#0x20]
...
STR             R1, [R4,#4]
STR             R0, [R4,#8]
ADD             SP, SP, #0x4C ; 'L'; jumptable 002748D8 default case, cases 0,2,4,5,7
VPOP            {D8}
POP             {R4-R11,PC}
ADD             R1, R6, #0x24 ; '$'; jumptable 002748D8 case 8
ADD             R0, R5, #0x24 ; '$'
BL              sub_275368
MOV             R1, #1
STRB            R0, [R7]
...
VPOP            {D8}
POP             {R4-R11,PC}
CMP             R10, #1; jumptable 002748D8 case 3
MOVEQ           R9, R2
MOVNE           R9, R3
CMP             R10, #2
MOV             R8, R5
...
POP             {R4-R11,LR}
B               sub_275840
CMP             R10, #4; jumptable 002748D8 case 6
LDR             R0, =off_6BC17C
MOVEQ           R8, R2
MOVNE           R8, R3
CMP             R10, #2
...
NOP
B               loc_275054
MOV             R0, R2; jumptable 002748D8 case 9
CMP             R10, #8
MOVNE           R0, R3
MOV             R2, R10
CMP             R2, #1
...
VPOP            {D8}
POP             {R4-R11,PC}
CMP             R10, #8; jumptable 002748D8 case 10
MOV             R0, R2
MOV             R1, R10
MOVNE           R0, R3
CMP             R1, #2
