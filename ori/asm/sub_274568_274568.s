...
ORR             R0, R0, R1
BICS            R1, R0, #0xF
BNE             def_274594; jumptable 00274594 default case, cases 0,2,4,5,7
CMP             R0, #0xB; switch 11 cases
LDRCC           PC, [PC,R0,LSL#2]; switch jump
B               def_274594; jumptable 00274594 default case, cases 0,2,4,5,7
DCD def_274594; jump table for switch statement
MOV             R0, R2; jumptable 00274594 case 1
MOV             R1, R3
...
MOV             R0, #0
B               loc_274828
ADD             R1, R3, #0x24 ; '$'; jumptable 00274594 case 8
ADD             R0, R2, #0x24 ; '$'
BL              sub_275368
NOP
NOP
B               loc_274828
LDR             R1, [R2,#0x18]; jumptable 00274594 case 3
MOV             R0, R2
MOV             R12, R2
CMP             R1, #1
MOVNE           R0, R3
...
NOP
B               loc_274828
LDR             R0, [R2,#0x18]; jumptable 00274594 case 6
...
NOP
B               loc_274828
LDR             R1, [R2,#0x18]; jumptable 00274594 case 9
MOV             R0, R3
CMP             R1, #8
MOVEQ           R0, R2
CMP             R1, #1
...
STRB            R0, [R4]
STR             R1, [R4,#4]
ADD             SP, SP, #0x50 ; 'P'; jumptable 00274594 default case, cases 0,2,4,5,7
POP             {R4-R6,PC}
LDR             R1, [R2,#0x18]; jumptable 00274594 case 10
MOV             R0, R2
MOV             R5, R2
CMP             R1, #8
MOVNE           R0, R3
